...
const BASE_URL = 'https://cdn.jsdelivr.net/gh/capriceyi/my-sofa-project@main/';
...
function loadSofa(index) {
    ...
    const modelPath = BASE_URL + modelFiles[index];
...
const mainColors248 = ['textures/ZJ-248-01.webp', 'textures/ZJ-248-02.webp', 'textures/ZJ-248-03.webp', 'textures/ZJ-248-04.webp', 'textures/ZJ-248-05.webp', 
    ...
    'textures/ZJ-248-11.webp', 'textures/ZJ-248-12.webp', 'textures/ZJ-248-13.webp'].map(path => BASE_URL + path);
const mainColorsS600 = ['textures/ZJ-S600-01.webp', 'textures/ZJ-S600-02.webp', 'textures/ZJ-S600-03.webp', 'textures/ZJ-S600-04.webp', 'textures/ZJ-S600-05.webp',
    'textures/ZJ-S600-06.webp', 'textures/ZJ-S600-07.webp', 'textures/ZJ-S600-08.webp', 'textures/ZJ-S600-16.webp'].map(path => BASE_URL + path);
const mainColorsW00 = ['textures/ZJ-W001.webp', 'textures/ZJ-W002.webp', 'textures/ZJ-W003.webp', 'textures/ZJ-W004.webp', 'textures/ZJ-W007.webp',
    'textures/ZJ-W010.webp', 'textures/ZJ-W011.webp', 'textures/ZJ-W012.webp', 'textures/ZJ-W013.webp', 'textures/ZJ-W014.webp'].map(path => BASE_URL + path);
const accentColorsP248 = ['textures/ZJ-P248-01.webp', 'textures/ZJ-P248-02.webp', 'textures/ZJ-P248-03.webp', 'textures/ZJ-P248-04.webp', 'textures/ZJ-P248-05.webp',
    ...
    'textures/ZJ-P248-31.webp'].map(path => BASE_URL + path);
const accentColorsPS600 = ['textures/ZJ-PS600-01.webp', 'textures/ZJ-PS600-02.webp', 'textures/ZJ-PS600-03.webp', 'textures/ZJ-PS600-04.webp', 'textures/ZJ-PS600-05.webp',
    ...
    'textures/ZJ-PS600-11.webp', 'textures/ZJ-PS600-14.webp', 'textures/ZJ-PS600-17.webp', 'textures/ZJ-PS600-18.webp'].map(path => BASE_URL + path);
const accentColorsPW00 = ['textures/ZJ-PW001.webp',  'textures/ZJ-PW004.webp',  'textures/ZJ-PW010.webp','textures/ZJ-PW011.webp', 'textures/ZJ-PW012.webp', 'textures/ZJ-PW008.webp', 
    'textures/ZJ-PW009.webp'].map(path => BASE_URL + path);
const accentColorsNapa = ['textures/24.webp','textures/41.webp','textures/44.webp','textures/45.webp','textures/46.webp','textures/47.webp','textures/49.webp','textures/50.webp',
    'textures/51.webp','textures/52.webp'].map(path => BASE_URL + path);
...
function applyTexture(texturePath, target) {
    const fullPath = BASE_URL + texturePath;
    textureLoader.load(fullPath, /* 保持原有逻辑 */);
    const textureLoader = new THREE.TextureLoader();
    textureLoader.setCrossOrigin(''); // 解决跨域问题
    textureLoader.load(
        texturePath,
        (texture) => {
            // 设置纹理颜色空间为sRGB
