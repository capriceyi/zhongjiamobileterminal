...
const CDN_BASE = 'https://cdn.jsdelivr.net/gh/capriceyi/my-sofa-project@main/';
...
function loadSofa(index) {
    const modelFiles = [
        CDN_BASE + 'models/sofa1.glb',
        CDN_BASE + 'models/sofa2.glb',
        CDN_BASE + 'models/sofa3.glb',
        CDN_BASE + 'models/sofa4.glb',
        CDN_BASE + 'models/sofa5.glb',
        CDN_BASE + 'models/sofa6.glb',
        CDN_BASE + 'models/sofa7.glb',
        CDN_BASE + 'models/sofa8.glb'
    ];
...
// 更新拉手模型路径
const handleModels = {
    Golden: CDN_BASE + 'models/golden-handle.glb',
    Silver: CDN_BASE + 'models/silver-handle.glb'
};
...
function addColorOptions(containerId, colorPaths, isMain) {
    ...
    colorPaths.forEach(relativePath => {
        // 检查是否已存在相同路径的选项
        ...
        colorPaths.forEach(relativePath => {  // 确保参数名一致
            const webpPath = CDN_BASE + relativePath;
